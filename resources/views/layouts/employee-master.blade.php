        ...
        columns: [
            ...
            { data: 'website', name: 'website' },
            {
              ...
              render: function(data, type, full, meta){
                return "<a class='btn btn-dark' href='/employee/companies/"+data+"''><i class='nav-icon fas fa-eye'></i></a>";
              },
              orderable: false
            }
      ...
      "autoWidth": false,
        ...
        columns: [
            ...
            { data: 'email', name: 'email'},
            {
              ...
              name: 'id',
              render: function(data, type, full, meta){
                return "<a class='btn btn-dark' href='/employee/employees/"+data+"''><i class='nav-icon fas fa-eye'></i></a>";
              },
              orderable: false
            }
        ]
